...
for x in linux-amd64 linux-armv7 linux-arm64v7 linux-armv6 linux-arm64v6 windows-amd64 macos-amd64 macos-aarch64; do
...
# tarballs for Linux
for x in linux-amd64 linux-armv7 linux-arm64v7 linux-armv6 linux-arm64v6; do
    cd dist/v$VERSION
